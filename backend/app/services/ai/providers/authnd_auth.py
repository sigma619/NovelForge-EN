...
def _apply_reasoning_payload(
    ...
    *,
    ...
    is_kimi = "moonshotai/kimi" in model_lower or "kimi-k2" in model_lower or "kimi-k3" in model_lower
...
def _parse_sse_lines(
    ...
    *,
    ...
    for raw_line in line_iter:
        ...
        if chunk_callback and (text or reasoning):
            chunk_callback(text, reasoning or None)
